...
import hz.library.gpuimage.GPUImage3x3ConvolutionFilter;
import hz.library.gpuimage.GPUImage3x3TextureSamplingFilter;
import hz.library.gpuimage.GPUImageAddBlendFilter;
import hz.library.gpuimage.GPUImageAlphaBlendFilter;
import hz.library.gpuimage.GPUImageBilateralFilter;
import hz.library.gpuimage.GPUImageBoxBlurFilter;
import hz.library.gpuimage.GPUImageBrightnessFilter;
import hz.library.gpuimage.GPUImageBulgeDistortionFilter;
import hz.library.gpuimage.GPUImageCGAColorspaceFilter;
import hz.library.gpuimage.GPUImageChromaKeyBlendFilter;
import hz.library.gpuimage.GPUImageColorBalanceFilter;
import hz.library.gpuimage.GPUImageColorBlendFilter;
import hz.library.gpuimage.GPUImageColorBurnBlendFilter;
import hz.library.gpuimage.GPUImageColorDodgeBlendFilter;
import hz.library.gpuimage.GPUImageColorInvertFilter;
import hz.library.gpuimage.GPUImageContrastFilter;
import hz.library.gpuimage.GPUImageCrosshatchFilter;
import hz.library.gpuimage.GPUImageDarkenBlendFilter;
import hz.library.gpuimage.GPUImageDifferenceBlendFilter;
import hz.library.gpuimage.GPUImageDilationFilter;
import hz.library.gpuimage.GPUImageDirectionalSobelEdgeDetectionFilter;
import hz.library.gpuimage.GPUImageDissolveBlendFilter;
import hz.library.gpuimage.GPUImageDivideBlendFilter;
import hz.library.gpuimage.GPUImageEmbossFilter;
import hz.library.gpuimage.GPUImageExclusionBlendFilter;
import hz.library.gpuimage.GPUImageExposureFilter;
import hz.library.gpuimage.GPUImageFalseColorFilter;
import hz.library.gpuimage.GPUImageFilter;
import hz.library.gpuimage.GPUImageFilterGroup;
import hz.library.gpuimage.GPUImageGammaFilter;
import hz.library.gpuimage.GPUImageGaussianBlurFilter;
import hz.library.gpuimage.GPUImageGlassSphereFilter;
import hz.library.gpuimage.GPUImageGrayscaleFilter;
import hz.library.gpuimage.GPUImageHalftoneFilter;
import hz.library.gpuimage.GPUImageHardLightBlendFilter;
import hz.library.gpuimage.GPUImageHazeFilter;
import hz.library.gpuimage.GPUImageHighlightShadowFilter;
import hz.library.gpuimage.GPUImageHueBlendFilter;
import hz.library.gpuimage.GPUImageHueFilter;
import hz.library.gpuimage.GPUImageKuwaharaFilter;
import hz.library.gpuimage.GPUImageLaplacianFilter;
import hz.library.gpuimage.GPUImageLevelsFilter;
import hz.library.gpuimage.GPUImageLightenBlendFilter;
import hz.library.gpuimage.GPUImageLinearBurnBlendFilter;
import hz.library.gpuimage.GPUImageLookupFilter;
import hz.library.gpuimage.GPUImageLuminosityBlendFilter;
import hz.library.gpuimage.GPUImageMonochromeFilter;
import hz.library.gpuimage.GPUImageMultiplyBlendFilter;
import hz.library.gpuimage.GPUImageNonMaximumSuppressionFilter;
import hz.library.gpuimage.GPUImageNormalBlendFilter;
import hz.library.gpuimage.GPUImageOpacityFilter;
import hz.library.gpuimage.GPUImageOverlayBlendFilter;
import hz.library.gpuimage.GPUImagePixelationFilter;
import hz.library.gpuimage.GPUImagePosterizeFilter;
import hz.library.gpuimage.GPUImageRGBDilationFilter;
import hz.library.gpuimage.GPUImageRGBFilter;
import hz.library.gpuimage.GPUImageSaturationBlendFilter;
import hz.library.gpuimage.GPUImageSaturationFilter;
import hz.library.gpuimage.GPUImageScreenBlendFilter;
import hz.library.gpuimage.GPUImageSepiaFilter;
import hz.library.gpuimage.GPUImageSharpenFilter;
import hz.library.gpuimage.GPUImageSketchFilter;
import hz.library.gpuimage.GPUImageSmoothToonFilter;
import hz.library.gpuimage.GPUImageSobelEdgeDetection;
import hz.library.gpuimage.GPUImageSoftLightBlendFilter;
import hz.library.gpuimage.GPUImageSourceOverBlendFilter;
import hz.library.gpuimage.GPUImageSphereRefractionFilter;
import hz.library.gpuimage.GPUImageSubtractBlendFilter;
import hz.library.gpuimage.GPUImageSwirlFilter;
import hz.library.gpuimage.GPUImageToneCurveFilter;
import hz.library.gpuimage.GPUImageToonFilter;
import hz.library.gpuimage.GPUImageTransformFilter;
import hz.library.gpuimage.GPUImageTwoInputFilter;
import hz.library.gpuimage.GPUImageVignetteFilter;
import hz.library.gpuimage.GPUImageWeakPixelInclusionFilter;
import hz.library.gpuimage.GPUImageWhiteBalanceFilter;
