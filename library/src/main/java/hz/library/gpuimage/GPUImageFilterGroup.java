...
import hz.library.gpuimage.util.TextureRotationUtil;

import static hz.library.gpuimage.GPUImageRenderer.CUBE;
import static hz.library.gpuimage.util.TextureRotationUtil.TEXTURE_NO_ROTATION;
